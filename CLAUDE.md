...
## Rule 7. Before writing, modifying, or reviewing any UI code, read DESIGN.md in full.
...
9. **Do not introduce conflicting visual systems**
...
10. **Validate UI output against `DESIGN.md`**
